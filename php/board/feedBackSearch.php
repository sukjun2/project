                                                    ...
                                                    if($result) {
                                                        ...
                                                        if($count > 0) {
                                                            for($i=0; $i < $count; $i++){
                                                                ...
                                                                $sql2 = "SELECT b.commentId FROM userMember a JOIN feedBackComment b ON (a.userMemberID = b.userMemberID) WHERE feedBackBoardID = ".$info[$searchBoardId]." ORDER BY commentId DESC";
                                                                ...
                                                                echo "<tr>";
                                                                    ...
                                                                    if($commentCount2 > 0){
                                                                        echo "<td class='lf'><a href='feedBackBoardView.php?feedBackBoardID={$info[$searchBoardId]}'>".$info['boardTitle']."<span class='comment'> (".$commentCount2.") </span>
                                                                        <p class='resinfo'>".$info['userNickName']. "|<span>".date('Y-m-d', $info['regTime'])." </span><em>| 조회수 : ".$info['boardView']."</em></p>
                                                                        </td>";
                                                                    } else {
                                                                        echo "<td class='lf'><a href='feedBackBoardView.php?feedBackBoardID={$info[$searchBoardId]}'>".$info['boardTitle']."<span class='comment'></span>
                                                                        <p class='resinfo'>".$info['userNickName']. "|<span>".date('Y-m-d', $info['regTime'])." </span><em>| 조회수 : ".$info['boardView']."</em></p>
                                                                        </td>";
                                                                    }
