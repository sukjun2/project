...
include "../connect/session.php";
    ...
    if($type == "categoryscroll"){
        ...
        if($page <= $categoryCount){
            ...
            $boardSql = "SELECT b.categgoryBoardID, b.categgoryTitle, i.userPhoto, i.userNickName, b.categgoryPhoto, b.categgoryView FROM categoryBoard as b JOIN categoryTag as t ON b.categgoryBoardID = t.categgoryBoardID JOIN userMember as i ON i.userMemberID = b.userMemberID JOIN categoryLike as q ON q.categgoryBoardID = b.categgoryBoardID GROUP BY b.categgoryBoardID ORDER BY b.categgoryBoardID DESC LIMIT {$viewLimit}, {$viewNum}";
